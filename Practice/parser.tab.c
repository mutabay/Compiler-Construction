...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_LPAR = 4,                       /* LPAR  */
  YYSYMBOL_RPAR = 5,                       /* RPAR  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "NUMBER", "LPAR",
  "RPAR", "PLUS", "MINUS", "MULTIPLY", "DIVIDE", "EOL", "$accept",
  "program", "expression", "term", "factor", YY_NULLPTR
};
...
{
       9,    10,     1,     2,    11,    14,     9,    10,     8,    12,
      13,    15,    16,     7,     0,    17,    18
};

static const yytype_int8 yycheck[] =
{
       6,     7,     3,     4,    10,     5,     6,     7,     0,     8,
       9,     9,    10,     2,    -1,    12,    13
};
...
#line 1093 "parser.tab.c"
  ...
  case 4: /* expression: expression PLUS term  */
#line 39 "parser.y"
                                 {
    char* temp = (char*)malloc(sizeof(char) * buffer);
    snprintf(temp, buffer, "t%d", labelCount++);
    Print3AddressCode("+", (yyvsp[-2].id), (yyvsp[0].id), temp);
    (yyval.id) = temp;
}
#line 1104 "parser.tab.c"
    break;

  case 5: /* expression: expression MINUS term  */
#line 46 "parser.y"
                                  {
    char* temp = (char*)malloc(sizeof(char) * buffer);
    snprintf(temp, buffer, "t%d", labelCount++);
...
#line 71 "parser.y"
               {
    char* temp = (char*)malloc(sizeof(char) * buffer);
    snprintf(temp, buffer, "%d", (yyvsp[0].num));
    (yyval.id) = temp;
}
#line 1155 "parser.tab.c"
    break;

  case 10: /* factor: LPAR expression RPAR  */
#line 77 "parser.y"
                             {
    (yyval.id) = (yyvsp[-1].id);
}
